...
First of all, you have to decompress the `.jar`. We compressed and split it in two files using 7z. However any file archiver should be able to decompress the archive.
#### To start the server
##### On Windows:
