...
public interface IPlayer {
    ...
    /**
     * Performs an {@link IMove} on the {@link CommonBoard} base on parameters taken from {@link IOController}.
     ...
     */
    void performMove(CommonBoard commonBoard, IOController ioController, IMove move);
