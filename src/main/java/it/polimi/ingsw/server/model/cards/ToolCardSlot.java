...
/**
 * A class that contains a {@link it.polimi.ingsw.server.model.cards.tool.ToolCard}.
...
public class ToolCardSlot {
    ...
    /**
     * Cost, in favor tokens, to use the {@link it.polimi.ingsw.server.model.cards.tool.ToolCard}. If it hasn't been used
