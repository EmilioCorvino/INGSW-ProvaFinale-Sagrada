...
import it.polimi.ingsw.server.model.Shade;
import it.polimi.ingsw.server.model.cards.objective.IObjectiveCardVisitor;
import it.polimi.ingsw.server.model.cards.objective.publics.strategies.IScoreComputationStrategy;
import it.polimi.ingsw.server.model.die.containers.WindowPatternCard;

/**
 * This type of {@link APublicObjectiveCard} relies on Die {@link it.polimi.ingsw.server.model.Shade} to compute the score,
...
public class ValuePublicObjectiveCard extends APublicObjectiveCard {
    ...
    /**
     * Applies the card strategy (based on {@link it.polimi.ingsw.server.model.Shade} to compute the score.
