...
//----------------------------------------------------------
     ...
     * the {@link it.polimi.ingsw.server.model.cards.objective.privates.PrivateObjectiveCard} drawn for each of them and to
    ...
    /**
     * This methods shows to the clients the {@link it.polimi.ingsw.server.model.cards.objective.privates.PrivateObjectiveCard}
     ...
     * {@link it.polimi.ingsw.server.model.die.containers.DiceDraftPool}, other players' {@link WindowPatternCard}s,
     * {@link it.polimi.ingsw.server.model.cards.objective.publics.APublicObjectiveCard}s and
     * {@link it.polimi.ingsw.server.model.cards.tool.ToolCard}s drawn.
     */
...
//----------------------------------------------------------
    ...
    /**
     * Converts the {@link it.polimi.ingsw.server.model.cards.objective.privates.PrivateObjectiveCard} of a player into its id.
     ...
     * @return id of the {@link it.polimi.ingsw.server.model.cards.objective.privates.PrivateObjectiveCard} owned by
     * the player.
     */
    ...
    /**
     * Converts the {@link it.polimi.ingsw.server.model.cards.objective.publics.APublicObjectiveCard}s drawn into an array of
     * integers, which are their id.
     * @return an array containing the drawn {@link it.polimi.ingsw.server.model.cards.objective.publics.APublicObjectiveCard}s'
     * ids.
     */
    ...
    /**
     * Converts the {@link it.polimi.ingsw.server.model.cards.tool.ToolCard}s drawn into an array of integers, which are their
     * id.
     * @return an array containing the drawn {@link it.polimi.ingsw.server.model.cards.tool.ToolCard}s' ids.
     */
