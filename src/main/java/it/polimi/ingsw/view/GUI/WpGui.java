...
public class WpGui extends Pane {
    ...
    public void checkBorder(Node pane, int row, int col) {
        ...
        if(row ==0 )
            pane.setStyle("-fx-border-width: 1px 0px 0px 0px");


        if(row == 2)
            pane.setStyle("-fx-border-width: 0px 0px 1px 0px");

        if(col == 0)
            pane.setStyle("-fx-border-width: 0px 0px 0px 1px");

        if(col == 3)
            pane.setStyle("-fx-border-width: 0px 1px 0px 0px");
